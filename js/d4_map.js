...
var altarIcon = { url: 'img/mapicons/Altar_Of_Lilith.webp', size: [100, 100] };
var dungeonIcon = { url: 'img/mapicons/Dungeon.webp', size: [100, 100] };
var cellarIcon = { url: 'img/mapicons/Cellar.webp', size: [100, 100] };
var waypointIcon = { url: 'img/mapicons/Waypoint.webp', size: [100, 100] };
var chestIcon = { url: 'img/mapicons/Helltide_Chest.webp', size: [100, 100] };
var eventIcon = { url: 'img/mapicons/Event.webp', size: [100, 100] };
var questIcon = { url: 'img/mapicons/Side_Quest.webp', size: [100, 100] };
var worldbossIcon = { url: 'img/mapicons/World_Boss.webp', size: [100, 100] };
var legioneventIcon = { url: 'img/mapicons/Legion_Event.webp', size: [100, 100] };
var namesToSearch = [];
var markers = [];
var locationMap = [];
