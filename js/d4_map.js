...
var zoneIcon = { url: 'img/zone/zone_dry_steppes.png', size: 100, 100] };
var zoneIcon = { url: 'img/zone/zone_kehjistan.png', size: [100, 100] };
var zoneIcon = { url: 'img/zone/zone_hawezar.png', size: [100, 100] };
var zoneIcon = { url: 'img/zone/zone_fractured_peaks.png', size: [100, 100] };
var zoneIcon = { url: 'img/zone/zone_scosglen.png', size: [100, 100] };
var namesToSearch = [];
var markers = [];
var locationMap = [];
var overlayMapNames = ['Waypoints', 'Dungeons', 'Altars of Lilith', 'Cellars', 'Helltide Chests', 'Events', 'Side Quests', 'World Boss', 'Legion Event','Zone'];
var icons = [waypointIcon, dungeonIcon, altarIcon, cellarIcon, chestIcon, eventIcon, questIcon, worldbossIcon, legioneventIcon, zoneIcon];
var groupings = [waypoints, dungeons, altars, cellars, chests, events, sidequests, worldboss, legionevents, zones];
var overlayMaps = {};
