...
var altarIcon = { url: 'img/mapicons/Altar_Of_Lilith.webp', size: [40, 40] };
var dungeonIcon = { url: 'img/mapicons/Dungeon.webp', size: [40, 40] };
var cellarIcon = { url: 'img/mapicons/Cellar.webp', size: [40, 40] };
...
var legioneventIcon = { url: 'img/mapicons/Legion_Event.webp', size: [40, 40] };
var namesToSearch = [];
var markers = [];
var locationMap = [];
